define([
    ...
    function load_extension () {
        ...
        var add_cmd_shortcuts = {
            'Alt-down': {
                help: 'Freeze and duplicate selected cell down',
                help_index: 'ht',
                handler: function() { 
                    Jupyter.notebook.copy_cell()
                    make_frozen_selected()
                    Jupyter.notebook.paste_cell_below()
                }
            },
            'Alt-up': {
                help: 'Freeze and duplicate selected cell up',
                help_index: 'ht',
                handler: function() { 
                    Jupyter.notebook.copy_cell()
                    make_frozen_selected()
        ...
        Jupyter.keyboard_manager.edit_shortcuts.add_shortcuts(add_cmd_shortcuts);        
